class RelevesController < ApplicationController
  ...
  private
    ...
    def releve_params
      params.require(:releve).permit(:date, :name, :structure, :fonction, :time_start, :time_end, :hauteur, :milieux, :user_id, :site_id, :gestion_id, :name_input, observations_attributes: [:id, :q0, :q1, :q2, :q3, :q4, :q5, :q6, :q7, :q8, :q9, :q10, :p, :espece_id, :releve_id, :_destroy], taxrefobservations_attributes: [:id, :q0, :q1, :q2, :q3, :q4, :q5, :q6, :q7, :q8, :q9, :q10, :p, :CD_REF, :CD_NOM, :LB_NOM, :NOM_VALIDE, :releve_id, :_destroy])
    end
end
