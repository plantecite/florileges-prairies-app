  ...
  private
    ...
    def releve_params
      params.require(:releve).permit(:date, :name, :structure, :fonction, :time_start, :time_end, :hauteur, :milieux, :user_id, :site_id, :created_at, :updated_at, :semis, :fauche, :fauche_periode, :fauche_freq, :fauche_export, :paturage, :paturage_pression, :paturage_duree, :traitement, :pression, observations_attributes: [:id, :q0, :q1, :q2, :q3, :q4, :q5, :q6, :q7, :q8, :q9, :q10, :p, :releve_id, :taxon_id, :created_at, :updated_at, :CD_NOM, :CD_REF, :LB_NOM, :NOM_VALIDE, :florileges, :TAXREF_V, :_destroy], woods_attributes: [:id, :q0, :q1, :q2, :q3, :q4, :q5, :q6, :q7, :q8, :q9, :q10, :total, :releve_id])
    end
end
